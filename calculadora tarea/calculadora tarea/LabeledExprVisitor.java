...
public interface LabeledExprVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code setModeGrados}
	 * labeled alternative in {@link LabeledExprParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSetModeGrados(LabeledExprParser.SetModeGradosContext ctx);
	/**
	 * Visit a parse tree produced by the {@code setModeRadianes}
	 * labeled alternative in {@link LabeledExprParser#stat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSetModeRadianes(LabeledExprParser.SetModeRadianesContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPower(LabeledExprParser.PowerContext ctx);
	/**
	 * Visit a parse tree produced by {@link LabeledExprParser#func}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunc(LabeledExprParser.FuncContext ctx);
}